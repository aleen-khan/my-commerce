                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal p-t-20" action="{{route('product.update', ['id' => $product->id])}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="number" class="form-control" value="{{$product->stock_amount}}" name="stock_amount" id="" placeholder="Product Stoke Amount">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea type="text" class="form-control summernote" name="long_description" id="exampleInputEmail3" placeholder="Long Description">{{$product->long_description}}</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <level><input type="radio" name="status" {{$product->status == 2 ? 'checked' : ''}} value="2"> Unpublished </level>
                            </div>
                        </div>
